...
int main( int, char** argv )
{
   ...
   createTrackbar("threshold", standard_name, &s_trackbar, max_trackbar, Standard_Hough);

   namedWindow( probabilistic_name, WINDOW_AUTOSIZE );
   createTrackbar( "threshold", probabilistic_name, &p_trackbar, max_trackbar, Probabilistic_Hough);
